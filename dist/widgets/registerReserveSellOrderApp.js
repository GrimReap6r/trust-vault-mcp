...
export function registerReserveSellOrderApp(server) {
    // --- UI resource: the card itself -------------------------------------
    registerAppResource(server, "Reserve Sell Order Card", RESOURCE_URI, {
        description: "Live reservation QR card for buying tokens from a SELL order -- scan to reserve, " +
    ...
    registerAppTool(server, "reserve_sell_order", {
        title: "Reserve against a SELL order (buy tokens)",
        description: "For a buyer purchasing tokens from an open SELL order. Renders a live reservation " +
    ...
    registerAppTool(server, "get_reservation_payment_link", {
        title: "Get reservation payment link (single check)",
        description: "Internal: single non-blocking lookup used by the reservation card's own poll loop -- " +
    ...
    registerAppTool(server, "get_reservation_receipt", {
        title: "Get reservation receipt (manual fallback)",
        description: "Internal: on-demand fallback receipt check for the reservation card's 'Check now' " +
    ...
    registerAppTool(server, "resolve_reserve_sell_order_signer", {
