...
export function registerReserveBuyOrderApp(server) {
    registerAppResource(server, "Reserve Buy Order Card", RESOURCE_URI, {
        description: "Live QR card for selling tokens into an open BUY order -- scan to sign, fiat lands in " +
    ...
    registerAppTool(server, "reserve_buy_order", {
        ...
        description: "For a token holder selling into an open BUY order. Renders a live QR card -- no wallet " +
