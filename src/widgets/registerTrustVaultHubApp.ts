...
export function registerTrustVaultHubApp(server: McpServer) {
  registerAppResource(
    server,
    "Trust Vault Hub",
    RESOURCE_URI,
    {
      description:
        "Live Trust Vault home -- current rates per currency, Buy/Sell tabs, and reservation " +
  ...
  registerAppTool(
    ...
    "open_trust_vault",
    {
      ...
      description:
        "Opens the Trust Vault home card: live buy/sell rates for every currency with liquidity " +
